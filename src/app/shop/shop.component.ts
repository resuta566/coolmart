...
export class ShopComponent implements OnInit, OnDestroy {
  ...
  getBrandId(id: any, isChecked: boolean) {
    ...
    if (isChecked) {
      ...
      const index = this.brandArray.indexOf(id);
  ...
  getHpCap(hp: any, isChecked: boolean) {
    ...
    if (isChecked) {
      ...
      const index = this.airconhpselectedArray.indexOf(hp);
  ...
  getTrCap(tr: any, isChecked: boolean) {
    ...
    if (isChecked) {
      ...
      const index = this.aircontrselectedArray.indexOf(tr);
  ...
  getCategoryId(id: number, isChecked: boolean) {
    ...
    if (isChecked) {
      ...
      const index = this.categoryArray.indexOf(id);
  ...
  getTypeId(id: number, isChecked: boolean) {
    ...
    if (isChecked) {
      ...
      const index = this.typeArray.indexOf(id);
